...
class ManageIQ::Providers::Autosde::Inventory::Persister::StorageManager < ManageIQ::Providers::Inventory::Persister
  ...
  def initialize_inventory_collections
    ...
    add_collection(storage, :storage_service_capability_values)
    add_collection(storage, :physical_storage_capability_values)
    add_collection(storage, :storage_resource_capability_values)
  end
end
