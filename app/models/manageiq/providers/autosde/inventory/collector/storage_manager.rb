...
class ManageIQ::Providers::Autosde::Inventory::Collector::StorageManager < ManageIQ::Providers::Inventory::Collector
  ...
  def physical_storage_capability_values
    @physical_storage_capability_values ||= @manager.autosde_client.StorageSystemCapabilityValueMappingApi.storage_system_capability_value_mapping_get
  end

  def storage_resource_capability_values
    @storage_resource_capability_values ||= @manager.autosde_client.StorageResourceCapabilityValueMappingApi.storage_resource_capability_value_mapping_get
  end
end
